{
  inputs =
    let
      version = "1.8.2";
system = "x86_64-linux";
devenv_root = "/home/ledesmx/projects/wf-privacy-policy";
devenv_dotfile = "/home/ledesmx/projects/wf-privacy-policy/.devenv";
devenv_dotfile_path = ./.devenv;
devenv_tmpdir = "/run/user/1000";
devenv_runtime = "/run/user/1000/devenv-dedd0a1";
